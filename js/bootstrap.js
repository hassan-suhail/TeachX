...
(function (global, factory) {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    const track = document.querySelector('.custom-auto-carousel-track');
    const images = track.querySelectorAll('a');
    ...
    function autoScroll() {
      ...
      const offset = currentIndex * (210 + 20); // 210mm width + 20px gap between images
